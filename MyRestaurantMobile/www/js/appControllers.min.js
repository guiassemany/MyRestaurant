mrc.controller('AppCtrl', ["$scope", "$ionicModal", "$timeout", "$state", "$auth", function($scope, $ionicModal, $timeout, $state, $auth) {
...
mrc.controller('MenuCategoryItemCtrl', ["$scope", function($scope) {
