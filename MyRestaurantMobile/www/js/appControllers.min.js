...
mrc.controller('CategoriesCtrl', ["$translate", "$state", "$ionicHistory", "$http", "CategoryService", function($translate, $state, $ionicHistory, $http, CategoryService) {
...
mrc.controller('ItemCtrl', ["$scope", "$state", "$stateParams", "ItemService", function($scope, $state, $stateParams, ItemService) {
  var vm = this;
